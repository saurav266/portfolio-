...
const certificates = [
  {
    ...
    image: "src/public/BAckend development certificate saurav-1.png",
    certificateImage: "src/public/BAckend development certificate saurav-1.png"  
  },
  {
  ...
  },
  {
    ...
    image: "", // Using available image as fallback
    certificateImage: ""
  },
  {
...
const achievements = [
  {
    ...
    date: "2024",
    description: "First third place in the annual coding hackathon, developing an innovative solution for healthcare accessibility.",
